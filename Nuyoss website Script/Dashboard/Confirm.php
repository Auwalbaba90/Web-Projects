		...
		<div class="row">
			...
			<center>
				<div class="col-half-q">
					<h1 style="color: green">Congrat. You Have Successully Voted this Candidate.... <br>Thanks For Vorting.</h1><br><a href="./vote.page.php"><button class="vote" style="width: 10%; border-radius: 5%; padding-top: 1%; padding-bottom: 1%; margin-left: 0%;"><i class="fa fa-arrow-left" aria-hidden="true">&nbsp;</i>Back</button></a>
				</div>
			</center>
