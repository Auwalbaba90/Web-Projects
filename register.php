...
<body>
	<div id="container">
		<?php include('header.php'); ?>
      	<form action="Register.php" id="form_sing_Up" method="Post" onsubmit="return validateForm()">
      		<div class="content">
      			<h1 class="Register-login">Register</h1><hr>
      					<div class="col-two2">
							<?php
																					...
																					require_once('./db_connection/db_connect.php');
																						...
																						$query="INSERT INTO users (First_name, Surname, Other_Name, Email_Address, Matric_No, Phone_No, State, Local_govt, Date_of_Birth, Gender, Password, Confirmation_Code) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
																							...
																							$affected_rows=mysqli_stmt_affected_rows($stmt);
																								...
																								if($affected_rows==1)
																								{
																									echo('<b style="color: green;"><i>Register Successully</i>.</b>');
																								}
																							else
																							{
																								echo '<b>'.$Email_Address.', </b><b style="color: red;"><i>Or</i></b> <b>'.$matric_no.'</b><br><i style="color: red;"> Already Exists Check and try Again.</i> ';
																							}
																						}
						...
						<div class="col-two">
         				...
         				<a href="./login.php" style="text-decoration: none;"><strong style="color: green; margin-bottom: 5%;"><i>Already have and Account Login.</i></strong></a>
						</div>
					</div>
					</form>
					 <script>
