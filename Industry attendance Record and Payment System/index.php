...
$ret=mysqli_query($con,"SELECT * FROM admin WHERE email_id='$mail' and Password='$upassword'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<h2><span style="color:#cc0000; font-family: Arial Black ">FICUS</span> <span style=" color:#008000; font-family: Arial Black  ">TREE </span> | Administrative</h2>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset style=" color:#008000;">
							...
							<p>
								Please enter your Sign in Email and password.<br />
					...
					<div class="copyright">
						<span class="text-bold text-uppercase">Ficus Tree Management System</span>
					</div>
