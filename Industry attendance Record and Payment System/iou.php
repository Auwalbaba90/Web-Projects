...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">I.O.U Invoice Record</h1>
</div>
<ol class="breadcrumb">
<li>
<span>I.O.U</span>
  ...
  $sql=("SELECT SUM(Amount) AS Total_amount FROM ioupay where Department IN ($dept) && Month='$month' && iou_status IN ($statuss)");
    ...
    ?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <form method="POST" name="Printiou" action="iou-invoice.php" target="Black">
            <input type="hidden" name="depts" id="depts" value="<?php echo $dept?>">
            <input type="hidden" name="status" id="status" value="<?php echo $statuss?>">
