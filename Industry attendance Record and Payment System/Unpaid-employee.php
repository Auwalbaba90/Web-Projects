...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Unpaid Employee Record</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Unpaid</span>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class=" table table-bordered table-hover">
            <center><strong style="font-size: 18px; font-family: Arial Black"><u>Voucher Invoice</u></strong></center>
            <thead>
              <tr></tr>
            <tr>
              <th>Employee ID</th>
