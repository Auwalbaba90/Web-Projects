...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Monthly PaySlip</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Monthly</span>
...
?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <form method="POST" name="Printpayslip" action="payslip.php" target="Black">
            <input type="hidden" name="ioumonth" id="ioumonth" value="<?php echo $Ioumonth?>">
