...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Staff Voucher Record</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Staff</span>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class=" table table-bordered table-hover">
            <center><strong style="font-size: 18px; font-family: Arial Black"><u>Staff Monthly Voucher</u></strong></center>
            <thead>
              <tr></tr>
            <tr>
              <th>Staff ID</th>
...
$sql=mysqli_query($con,"SELECT Employee_id, Full_name, SUM(Salary) AS Total_Slary, Department, Payment_status, Payment_method, COUNT(*) AS employee_attendance FROM attendance WHERE Payment_status='Unpaid' && Department IN ($dept) && date(At_Date) between '$fdate' and '$tdate' GROUP BY Employee_id order by employee_attendance DESC");
$cnt=1;
...
?>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                <th style="width:50%">Voucher Record:</th>
  ...
  $sql=("SELECT Employee_id, COUNT(*) AS totalemployee FROM attendance WHERE Payment_status='Unpaid' && Department IN ($dept) && date(At_Date) between '$fdate' and '$tdate' GROUP BY Employee_id");
  ...
  $sql=("SELECT SUM(Salary) AS Total_amount FROM attendance where Payment_status='Unpaid' && Department IN ($dept) && date(At_Date) between '$fdate' and '$tdate'");
    ...
    ?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <form method="POST" name="Printvoucher" action="voucher-print.php" target="Black">
