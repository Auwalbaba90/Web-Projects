...
?>
	...
	<div class="form-group">
	   ...
	   <input type="Number" class="form-control" id="Student_no" onBlur="userAvailability()" name="Student_no" required="required" title="Student Reg No">
	...
	<div class="form-group">
	   ...
	   <input type="text" class="form-control" name="House" id="House"  title="House" required="required">
	 </div>	
