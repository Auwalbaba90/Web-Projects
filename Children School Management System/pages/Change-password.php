...
include('../config/config.php');
	if(isset($_POST['Change_P']))
	{
		...
		$query=mysqli_query($db,"UPDATE `staff_account` SET Password='$N_Password' WHERE Staff_ID='".$_SESSION['submit']."'");
		if($query)
	{
...
<!--nav-->
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h4 class="page-header"> <!--<?php echo strtoupper("User ID:"."<i style='color: #00b300;'> ".htmlentities($_SESSION['submit']));?></i >--></h4>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
