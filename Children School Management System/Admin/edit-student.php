...
<form method="post" >
  ...
  <div class="form-group">
    ...
    <div class="col-lg-6">
     <input type="text" class="form-control" value="<?php echo $Addmission_No ;?>" id="Student_no" name="Student_no" required="required" title="Student Reg No">
   </div> 
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-6">
     <select class="form-control" id="House" name="House" required="required" title="Student House">
